...
fetches them into ``~/.iwfm/dlls/<version>/`` where :func:`iwfm.load_dll`
already looks.

Usage::

    import iwfm
    iwfm.download_dll("2025.0.1747")
    model = iwfm.IWFMModel(..., dll_version="2025.0.1747")
"""
...
def download_dll(version=DEFAULT_VERSION, dest_dir=None, force=False,
    ...
    if show_progress:
        ...
        print(f'Use it with iwfm.load_dll(version="{version}") or '
