"""Quick test: exercise all 58 plot functions from the sample model."""
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
os.chdir(os.path.join(os.path.dirname(__file__),
                       "..", ".assets", "sample_model", "Simulation"))
...
PP = os.path.abspath(
    os.path.join("..", "Preprocessor", "PreProcessor_MAIN.IN"))

with iwfm.IWFMModel(
    preprocessor_file=PP,
    simulation_file="Simulation_MAIN.IN",
    is_for_inquiry=True,
) as m:
